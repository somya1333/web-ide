...
declare module "canvas" {
    ...
    export const Canvas: React.MemoExoticComponent<({ children, gl, camera, orthographic, raycaster, style, pixelRatio, vr, invalidateFrameloop, onCreated, ...rest }: CanvasProps) => JSX.Element>;
}
